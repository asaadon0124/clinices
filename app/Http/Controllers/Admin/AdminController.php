...
class AdminController extends Controller
{
    ...
    public function allContentInDashboard(){
        ...
        $weakly_appointments = Day::withCount('appointments')->get();

        $weekly_earnings = Day::with(['reservations.feese'])
        ->orderBy('date', 'asc')
        ->get()
        ...
        return $this->data(compact('users_count_of_reservations', 'weakly_appointments', 'weekly_earnings'));
    }
